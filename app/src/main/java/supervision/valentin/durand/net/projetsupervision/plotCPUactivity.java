...
public class plotCPUactivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < arrayF.size(); i++) {
            ordonne[i] = Float.parseFloat(arrayF.get(i).mesure);
        }
        ...
        XYSeries graphTemp = new SimpleXYSeries(Arrays.asList(abscisse), Arrays.asList(ordonne), "Activité du processeur");
